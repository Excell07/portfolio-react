            ...
            <span className="nav__list__section">
              ...
              <NavLink className="nav__list__section__item" to="/">
                <li className="nav__list__section__item__img-container">
                  <img src={profile} alt="" className="nav__list__section__item__img-container__img"/>
                </li>
              </NavLink>
              ...
              <NavLink className="nav__list__section" to='/about' activeClassName="desktop-nav-active">
                <li className="nav__list__section__text">About</li>
              </NavLink>
