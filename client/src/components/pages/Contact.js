    ...
    return (
      <div id="contactForm">
        <Hero 
          ...
          subHeader="Tell me about yourself."
          backGround="contact-bg"
        />
        <div className="full-width-row cta-form--bg">
          <div className="row-container">
            <form className="cta-form">
              <label htmlFor="name" className="cta-form__label">Name</label>
              <input 
                name="name"
              ...
              <label htmlFor="email" className="cta-form__label">Email</label>
              <input 
                name="email"
              ...
              <label htmlFor="subject" className="cta-form__label">Subject</label>
              <input 
                name="subject"
              ...
              <label htmlFor="message" className="cta-form__label">Message</label>
              <textarea 
                name="message"
                onChange={e => this.change(e)}
