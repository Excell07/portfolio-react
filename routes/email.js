...
mongoose.connect(process.env.MONGOLAB_URI || 'mongodb://127.0.0.1:27017/clientWeb', {useNewUrlParser: true})
...
module.exports = app => {
	app.post('/send-email', [
		...
		.save(function (err, doc) {
			if (err)
				res.json('Whoops! I\'m sorry, an error happened while sending your message. Please send a message directly to <a href="mailto:developerzero7@gmail.com">developerzero7@gmail.com');
			else
